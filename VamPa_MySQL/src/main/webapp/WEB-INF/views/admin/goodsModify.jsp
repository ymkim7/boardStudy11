			...
			<form action="/admin/goodsModify" method="post" id="modifyForm">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="bookName" name="bookName" value="${goodsInfo.bookName}">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="publisher" name="publisher" value="${goodsInfo.publisher}">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="bookPrice" name="bookPrice" value="${goodsInfo.bookPrice}">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="bookStock" name="bookStock" value="${goodsInfo.bookStock}">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="discount_interface" name="discount_interface" maxlength="2" value="0">
						<input id="bookDiscount" name="bookDiscount" type="hidden" value="${goodsInfo.bookDiscount}">
