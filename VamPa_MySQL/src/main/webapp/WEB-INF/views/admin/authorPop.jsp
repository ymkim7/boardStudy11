	           	...
	           	<ul class="pageMaker">
		           	...
		           	<c:if test="${pageMaker.prev}">
		           		<li class="pageMaker_btn prev">
		           			<a href="authorPop?pageNum=${pageMaker.pageStart - 1}&amount=${pageMaker.cri.amount}">이전</a>
		           		</li>
		           	</c:if>
		           	...
		           	<c:forEach begin="${pageMaker.pageStart}" end="${pageMaker.pageEnd}" var="num">
		           		<li class='pageMaker_btn ${pageMaker.cri.pageNum == num ? "active":""}'>
		           			<a href="authorPop?pageNum=${num}&amount=${pageMaker.cri.amount}">${num}</a>
		           		</li>
		           	</c:forEach>
		           	...
		           	<c:if test="${pageMaker.next}">
		           		<li class="pageMaker_btn next">
		           			<a href="authorPop?pageNum=${pageMaker.pageEnd + 1 }&amount=${pageMaker.cri.amount}">다음</a>
		           		</li>
		           	</c:if>
	           </ul>
			</div>
